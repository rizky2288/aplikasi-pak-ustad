        ...
        <div class="col-12">
            ...
            <div class="card-header unselect">
                <span><i class="fa fa-wifi"></i>&nbsp; <b>Hotspot</b> &nbsp; </span>
                    <span class="card-tab" id="btn-hotspot-users"><i class="fa fa-users" ></i> User</span>
                    <span class="card-tab" onclick="loadUserProfiles()" id="btn-user-profiles"><i class="fa fa-pie-chart" ></i>Profil User</span>
                    <span class="card-tab" onclick="loadHotspotActive()" id="btn-hotspot-active"><i class="fa fa-wifi" ></i> Aktif</span>
                    <span class="card-tab" onclick="loadHotspotHosts()" id="btn-hotspot-hosts"><i class="fa fa-laptop" ></i> Host</span>
            </div>
            <div class="card-body">
            <div class="row">
                <div class="col-12 hide" id="user-profiles">
                    ...
                    <div class="btn-group btn-container">
                        <button class="bg-btn-group btn-add-user-profiles" ><i class="fa fa-plus" ></i>  Tambah</button>
                    </div>
                    ...
                    <table class="table table-bordered table-hover user-profiles">
                        <thead>
                            <tr>
                                ...
                                <th>Nama</th>
                                <th>Pengguna Bersama</th>
                                <th>Batas Tarif</th>
                                <th>Mode Kedaluwarsa</th>
                                <th>Validitas</th>
                                <th>Harga</th>
                                <th>Harga Jual</th>
                                <th>Pengunci User</th>
                                <th>Pengunci Server</th>
                            </tr>
                        </thead>
                        <tbody id="profiles">
                            <tr>
                ...
                <div class="col-12 hide" id="hotspot-users">
                    ...
                    <div class="btn-group btn-container" >
                        <button class="bg-btn-group btn-add-hotspot-users" onclick="" ><i class="fa fa-user-plus" ></i> Tambah</button>
                    </div>
        ...
        <div class="mobile-card ">
            <div class="col-12 mr-b-10">
                ...
                <div class="dropdown">
                      ...
                      <div id="mDropdown" class="dropdown-content">
                        <a id="btn-hotspot-users"><i class="fa fa-users" ></i> User</a>
                        <a id="btn-user-profiles"><i class="fa fa-pie-chart" ></i> Profil User</a>
                        <a id="btn-hotspot-active"><i class="fa fa-wifi" ></i> Aktif</a>
                        <a id="btn-hotspot-hosts"><i class="fa fa-laptop" ></i> Host</a>
                      </div>
                    </div>
                </div>
             </div>
            ...
            <div class="row">
                <div class="col-12 hide" id="user-profiles">
                    ...
                    <div class="btn-group btn-container">
                    <button class="btn-mobile bg-btn-group btn-add-user-profiles" ><i class="fa fa-plus" ></i>  Tambah</button>
                    </div>
                    
                    <div class="btn-group btn-container" >
                        <button class="btn-mobile bg-btn-group btn-add-hotspot-users" id=""><i class="fa fa-user-plus" ></i> Tambah User</button>
...
<div id="addh_userprofile" class="modal unselect">
  <div class="modal-content<?=$modal_mobile;?>">
    ...
    <div class="modal-header<?=$modal_mobile;?>">
        ...
        <span id="usrproftt"><i class="fa fa-pie-chart"></i>&nbsp; <b>Tambah Profil</b> &nbsp; </span>
        <span class="card-tab card-tab-active" id="btn-upgeneral">General</span>
        <span class="card-tab" onclick="" id="btn-updetails">Detail</span>

    </div>
    <div class="modal-body<?=$modal_mobile;?>">
        <div id="upgeneral">
            <table class="table">
              <tr><td>Nama</td><td><input id="add_usrprofid" autocomplete="off" class="form-control" type="hidden" value="0" /><input id="add_usrprofname" autocomplete="new-password" class="form-control" type="text" /></td></tr>
              <tr><td>Address Pool</td><td>
                  <select class="form-control" id="add_addrpool">
                  <option value="none">none</option>
                  </select>
              </td></tr>
              <tr><td>Pengguna Bersama</td><td><input id="add_sharedusr"  autocomplete="new-password" class="form-control" type="number" value="1"  min="0" max="999"/></td></tr>
              <tr id="trratelimit"><td>Batas Tarif<span id="hRateLimit" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td><input id="add_ratelimit" autocomplete="off" class="form-control" type="text" /></td></tr>
        ...
        <div id='updetails' class="hide">
            <table class="table">
        <tr id="trexpmode"><td >Mode Kedaluwarsa <span id="hExpMode" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td>
              ...
              <tr id="trvalidity" class="hide"><td>Validitas <span id="hValidity" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td><input id="add_validity" autocomplete="off" class="form-control" type="text" onkeyup="this.value = this.value.toLowerCase();" /></td></tr>
              <tr><td>Harga</td><td><input id="add_price" autocomplete="off" class="form-control" type="number" /></td></tr>
              <tr><td>Harga Jual</td><td><input id="add_sellingprice" autocomplete="off" class="form-control" type="number" /></td></tr>
              ...
              <tr id="trlockserver"><td >Pengunci Server <span id="hLockServer" title="help" class="mr-t-5 text-center pointer"><i class="fa fa-question-circle"></i></span</td><td>
        ...
        <div>
            <table class="table">
                <tr>
                    <td>
                        <button class="btn bg-primary" style="float: right;" onclick="addUserProfile()"><i class="fa fa-save"></i> Simpan</button>
                        <span id="usrprofact-btn" style="display: none">
                            
                            <button class="btn bg-danger" style="float: right;" onclick=" remProf()"><i class="fa fa-minus-square"></i> Hapus</button>
                        </span>
                    </td>
                </tr>
            </table>
  ...
  <div class="modal-content<?=$modal_mobile;?>">
    ...
    <div class="modal-header<?=$modal_mobile;?>">
      ...
      <!-- <h3 ><i class="fa fa-user-plus"></i> Add User</h3> -->
        ...
        <span id="usrtt"><i class="fa fa-user-plus"></i>&nbsp; <b>Tambah User</b> &nbsp; </span>
        <span class="card-tab card-tab-active" id="btn-general">General</span>
        <span class="card-tab" onclick="" id="btn-details">Detail</span>
    </div>
    <div class="modal-body<?=$modal_mobile;?>">
        <div id="ugeneral">
            <table class="table">
