            ...
            <div class="col-6">
              <div class="box bmh-80 box-yellow">
                <div class="box-group">
                  ...
                  <div class="box-group-icon" style="height: 90px;"><i class="fa fa-wifi"></i>
                    <div>Aktif</div>
                  </div>
                </div>
            ...
            <div class="col-6">
              <div class="box bmh-80 box-red">
                <div class="box-group">
                  ...
                  <div class="box-group-icon" style="height: 90px;"><i class="fa fa-users"></i>
                    <div>User</div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-12">
          <div class="row">
            <div class="col-6">
              <div class="card card-shadow">
                <div class="card-header">
                  <h3><i class="fa fa-tasks"></i> Perangkat <span id="identity"></span></h3>
                </div>
            ...
            <div class="col-6">
              <div class="card card-shadow">
                <div class="card-header">
                  <h3><i class="fa fa-info-circle"></i> Info Sistem</h3>
                </div>
                <div class="card-body card-body-rb">
                  <table class="table table-hover text-nowrap unselect" style="font-size: 13px;">
                    <tr>
        ...
        <div class="col-12">
          <div class="row">
            <div class="col-12">
              <div class="card card-shadow">
                <div class="card-header">
                  <h3><i class="fa fa-file-text"></i> History Aplikasi</h3>
                </div>
                <div class="card-body card-body-rb">
            ...
            <div class="col-12">
              <div class="card card-shadow">
                <div class="card-header">
                  <h3><i class="fa fa-file-text"></i> History Hotspot</h3>
                </div>
                <div class="card-body card-body-rb">
    ...
    <div class="main-mobile">
          ...
          <div class="col-6">
            <div class="box bmh-60 box-red">
              <div class="box-group">
                ...
                <div class="box-group-icon" style="height: 60px;"><i class="fa fa-wifi"></i>
                  <div>Aktif</div>
                </div>
              </div>
            </div>
          ...
          <div class="col-6">
            <div class="box bmh-60 box-yellow">
              <div class="box-group">
                ...
                <div class="box-group-icon" style="height: 60px;"><i class="fa fa-users"></i>
                  <div>User</div>
                </div>
              </div>
            </div>
            ...
            <div class="box bmh-60 box-green">
              <div class="box-group">
                <div class="box-group-area text-left">
                  <span style="font-size:10px;margin-bottom:2px;">Bulan ini: </span><br><span style="font-size:20px;" class="box-group-text" id="live-report-month">-</span><br>
                  <span style="font-size:10px;margin-bottom:2px;">Hari ini: </span><br><span style="font-size:15px;" class="box-group-text" id="live-report-day">-</span>
                </div>
                <div class="box-group-icon"><i class="fa fa-money"></i>
                  <div>Penghasilan</div>
                </div>
              </div>
            </div>
      ...
      <div class="w-12" style="padding-bottom:100px;">
        ...
        <div class="mobile-card">
          <h3><i class="fa fa-server"></i> Perangkat</h3>
