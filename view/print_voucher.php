...
';
  ...
  if (file_exists($logo)) {
    $logo = "./assets/img/logortrw.png?" . date("YmdHis");
  } else {
    $logo = "./assets/img/logortrw.png";
  }
  ...
  if (!isset($prev)) {
    ...
    $get_users = array(
      0 => array("name" => "NET-" . rand(0, 10000), "password" => rand(), "profile" => "1day", "limit-uptime" => "1d", "limit-bytes-total" => 10737418240, "comment" => "RT RW NET-preview")
    );
    $TotalReg = count($get_users);
    $validity = "1d";
    $getprice = "3";
    $getsprice = "5000";
    $hotspotname = "RT RW NET";
    $dnsname = "rtrwnet";
    $phone = "6281xxxxxxxxx";
    $currency = "Rp. ";
  }
