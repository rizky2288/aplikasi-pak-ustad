                ...
                <div class="col-12">
                    <div class="card card-shadow">
                        <div class="card-header select">
                            ...
                            <!-- <span><i class="fa fa-gear"></i> <b>Pengaturan</b> </span>&nbsp; -->
                            <span class="card-tab card-tab-active" id="btn-mm-admin"><i class="fa fa-user-circle"></i> Admin</span>


                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 " id="mm-admin">
                                    <div class="btn-group">
                                        <button class="bg-btn-group mt-3" id="btn-asave"><i class="fa fa-save"></i> Simpan</button>
                                    </div>
                                    <div class="card-fixed mr-t-5">
                                        ...
                                        foreach (file('./config/config.php', FILE_SKIP_EMPTY_LINES) as $line) {
                                            $s = explode("'", $line)[1];
                                            $useradm = get_config($line, 'rtrwnet<|<', "'");
                                            $passadm = get_config($line, 'rtrwnet>|>', "'");
                                            if ($s == "rtrwnet") { ?>
                                ...
                                <div class="col-12 hide" id="router-list">
                                    <div class="btn-group">
                                        <button class="bg-btn-group tooltip" id="btn-add-router"><i class="fa fa-plus"></i> Tambah Router
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody id="table-router-list">
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            <script>
                                                                localStorage.setItem("?<?= $s; ?>_idleto", "<?= $idleto ?>")
                                                            </script>
                                ...
                                ?>
                                            <script>
                                                $(document).ready(function() {
                                                    $("#edit-router").removeClass('hide')
                                                })
                                            </script>
                                            <script>
                                                localStorage.setItem("?<?= $_GET["r"]; ?>_idleto", "<?= $idleto ?>")
                                            </script>
                                            <div class="col-12 hide" id="edit-router">
                                                <div class="card-fixed">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="btn-group">
                                                                <button class="bg-btn-group" onclick="location.replace('./?admin/settings')"><i class="fa fa-close"></i> Tutup</button>
                                                                <button class="bg-btn-group" onclick="removeRouter('<?= $_GET['r']; ?>')"><i class="fa fa-trash"></i> Hapus</button>
                                                                <button class="bg-btn-group" id="saveR"><i class="fa fa-save"></i> Simpan</button>
                                                                <button class="bg-btn-group" id="rConnect"><i class="fa fa-plug"></i> Hubungkan </button>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="card-sq">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <table class="table">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="min-width:100px">Nama Sesi</td>
                                                                ...
                                                                <div class="card-sq">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <table class="table">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="min-width:100px">Nama Hospot</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td>Batas Waktu Sesi</td>
                                                                                    <td>
                                                                                        <select id="idleTo" class="form-control asave pointer">
                                                                                            <!-- <option value="<?= $idleto; ?>"><?php echo ucfirst($idleto);
                                                                                                                                    if ($idleto != "disable") {
                                                                                                                                        echo " minutes";
                                                                                                                                    } ?> </option> -->
                                                                        ...
                                                                        <div class="card-body">
                                                                            <table class="table table-bordered table-hover" style="font-size: 14px;">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>Nama Sesi</td>
                                                                                        <td>Isi dengan satu kata tanpa ada karakter khusus.</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Nama DNS</td>
                                                                                        <td>Silakan cek di Winbox, menu IP -> Hotspot -> Profil Server.</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Idle Timeout</td>
                                                                                        <td>Idle timeout adalah waktu hitung mundur untuk logout.</td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </div>
                ...
                <div class="col-12" style="margin-bottom:100px;">
                    ...
                    <div class="mobile-card ">
                        ...
                        <div class="col-12 mr-b-10">
                            ...
                            <div class="col-10">
                                <h3><span id="pload"><i class="fa fa-th-list"></i> List Router</span></h3>
                            </div>
                            <div class="col-2">
                                <div class="dropdown">
                                    ...
                                    <div id="mDropdown" class="dropdown-content">
                                        ...
                                        <a id="btn-router-list"><i class="fa fa-th-list"></i> List Router</a>
                                        <?php if (isset($_GET['r']) && !empty($_GET['r'])) { ?>
                                                ...
                                                foreach (file('./config/config.php', FILE_SKIP_EMPTY_LINES) as $line) {
                                                    ...
                                                    if ($s == "" || $s == "rtrwnet") {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="box-mobile"><i class="fa fa-wifi" id="<?= $s; ?>p"></i> <b> <?= $hn; ?></b><span style="float:right;">[<?= $i ?>]</span> <br>
                                                                    Session Name: <?= $s; ?><br>
