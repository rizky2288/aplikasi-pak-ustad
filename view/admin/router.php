                ...
                <div class="col-12">
                    <div class="card card-shadow">
                        <div class="card-header select">
                            <span class="card-tab card-tab-active" id="btn-router-list"><i class="fa fa-th-list"></i> List Router</span>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 hide" id="mm-admin">
                                    <div class="btn-group">
                                        <button class="bg-btn-group" id="btn-asave"><i class="fa fa-save"></i> Simpan</button>
                                    </div>
                                            ...
                                            <div class="col-12 hide" id="edit-router">
                                                <div class="card-fixed">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="btn-group">
                                                                <button class="bg-btn-group" onclick="location.replace('./?admin/listrouter')"><i class="fa fa-close"></i> Tutup</button>
